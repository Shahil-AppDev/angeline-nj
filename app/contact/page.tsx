            ...
            <Card className="p-8">
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <div className="text-left">
                    <div className="font-semibold text-text">YouTube</div>
                    <div className="text-sm text-muted">@angelinenj-j7z</div>
                  </div>
                </a>
                ...
                >
                  ...
                  <div className="text-left">
                    <div className="font-semibold text-text">Facebook</div>
              ...
              <div className="mt-8 p-4 bg-primary/5 rounded-lg border border-gold-2/20">
                <p className="text-text-2 text-center">
                  ...
                  Contactez-moi sur Instagram, TikTok, YouTube ou Facebook pour toute demande de consultation, tirage ou soin Reiki.
                </p>
              </div>
            </Card>
          </div>
